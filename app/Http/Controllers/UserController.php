...
class UserController extends Controller
{
    ...
    public function kerusakanPost(Request $request)
    {
        ...
        $gambarrusak1 = $request->file('gambar1');
        $rusak1       = time().'.'.$gambarrusak1->getClientOriginalExtension();
        $gambarrusak1->move(public_path('uploadkamar'), $rusak1);
        $gambarrusak2 = $request->file('gambar2');
        $rusak2       = time().'.'.$gambarrusak2->getClientOriginalExtension();
        $gambarrusak2->move(public_path('uploadkamar'), $rusak2);
        $gambarrusak3 = $request->file('gambar3');
        $rusak3       = time().'.'.$gambarrusak3->getClientOriginalExtension();
        $gambarrusak3->move(public_path('uploadkamar'), $rusak3);
        $gambarrusak4 = $request->file('gambar4');
        $rusak4       = time().'.'.$gambarrusak4->getClientOriginalExtension();
        $gambarrusak4->move(public_path('uploadkamar'), $rusak4);
