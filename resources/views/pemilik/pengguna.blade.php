        ...
        <div class="sticky-top" id="stickyTop">
            <div class="container py-3 mb-0">
                <div class="row" x-show="openSearch === false">
                    <div class="col-9 text-end mb-0">
                        <h3 class="fw-semibold" id="seachText" style="font-size: 15px;">Daftar Pengguna <span style="color: #B19CD9;">(8)</span></h3>
                    </div>
                    <div class="col-3 text-end" style="margin-top: -2px; mb-0">
                ...
                <div class="container" x-show="openSearch === true">
                    <input id="searchInput" type="text" class="form-control  search-input w-100" placeholder="Cari...">
                </div>
            </div>
        </div>
        <hr class="garis-pemisah-1" style="border-top: 10px solid #ccc; margin-top: -4px; margin-bottom: 0px;" @click="openSearch = false">
        <div class="container py-2" style="margin-bottom: 60px;" @click="openSearch = false">
            <div class="row g-2">
                <div class="col-6">
                    <div class="card" style="border: none">
                        <img src="{{ asset('img/customer1.jpg') }}" class="card-img" style="opacity: 0.9" alt="...">
                        <div class="card-img-overlay p-0">
                            <div class="text-content" style="margin-top: 160px; background-color: rgba(0, 0, 0, 0.5); height: 40px; width: 162px; border-bottom-left-radius: 8px; border-bottom-right-radius: 8px;">
                                <div class="ms-2">
                    ...
                    <div class="card" style="border: none">
                        ...
                        <div class="card-img-overlay p-0">
                            <div class="text-content" style="margin-top: 160px; background-color: rgba(0, 0, 0, 0.5); height: 40px; width: 162px; border-bottom-left-radius: 8px; border-bottom-right-radius: 8px;">
                                <div class="ms-2">
                                    <div class="text-title-content" style="font-size: 12px;">
                                        <p class="text-white fw-medium mb-0">Dedy Hermawan</p>
                                    </div>
                                    <div class="d-flex">
                    ...
                    <div class="card" style="border: none">
                        ...
                        <div class="card-img-overlay p-0">
                            <div class="text-content" style="margin-top: 160px; background-color: rgba(0, 0, 0, 0.5); height: 40px; width: 162px; border-bottom-left-radius: 8px; border-bottom-right-radius: 8px;">
                                <div class="ms-2">
                                    <div class="text-title-content" style="font-size: 12px;">
                                        <p class="text-white fw-medium mb-0">Dian Saputra</p>
                                    </div>
                                    <div class="d-flex">
                    ...
                    <div class="card" style="border: none">
                        ...
                        <div class="card-img-overlay p-0">
                            <div class="text-content" style="margin-top: 160px; background-color: rgba(0, 0, 0, 0.5); height: 40px; width: 162px; border-bottom-left-radius: 8px; border-bottom-right-radius: 8px;">
                                <div class="ms-2">
                                    <div class="text-title-content" style="font-size: 12px;">
                                        <p class="text-white fw-medium mb-0">Eko Saputro</p>
                                    </div>
                                    <div class="d-flex">
                                        <p class="text-white-50 font-tag-content mb-1" style="font-size: 10px;">20 Mei 2023</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card" style="border: none">
                        ...
                        <div class="card-img-overlay p-0">
                            <div class="text-content" style="margin-top: 160px; background-color: rgba(0, 0, 0, 0.5); height: 40px; width: 162px; border-bottom-left-radius: 8px; border-bottom-right-radius: 8px;">
                                <div class="ms-2">
                                    <div class="text-title-content" style="font-size: 12px;">
                                        <p class="text-white fw-medium mb-0">Joko Santoso</p>
                                    </div>
                                    <div class="d-flex">
