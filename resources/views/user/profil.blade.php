...
<body>
    ...
    <div class="container px-4">
        <section class="card-list">
            <button class="btn-edit-profil" data-bs-toggle="modal" data-bs-target="#editprofil"><i class="bi bi-pencil" style="font-size: 16px; margin-left: 10px; margin-right: 10px; color: #9370DB;"></i>Profil<i class="bi bi-arrow-right text-secondary" style="font-size: 16px; margin-left: 12.8rem;"></i></button>
            <!-- Modal -->
                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-12 text-center mt-3">
                                        <button id="saveButton" class="btn" style="background-color: #9370DB; color: white; border: none;" disabled>Simpan</button>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <button class="btn-edit-akun" data-bs-toggle="modal" data-bs-target="#editakun"><i class="bi bi-person-gear" style="font-size: 16px; margin-left: 10px; margin-right: 10px; color: #9370DB;"></i>Akun<i class="bi bi-arrow-right text-secondary" style="font-size: 16px; margin-left: 12.8rem;"></i></button>
            <!-- Modal -->
                        ...
                        <div class="modal-body">
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-12 text-center mt-3">
                                        <button id="simpanAkunButton" class="btn" style="background-color: #9370DB; color: white; border: none;" disabled>Simpan</button>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <form action="/favorit">
                <button class="btn-edit-akun"><i class="bi bi-heart" style="font-size: 16px; margin-left: 10px; margin-right: 10px; color: #9370DB;"></i>Kamar Kost Favorit<i class="bi bi-arrow-right text-secondary" style="font-size: 16px; margin-left: 6.8rem;"></i></button>
            </form>
            <button class="btn-edit-akun" data-bs-toggle="modal" data-bs-target="#bantuan"><i class="bi bi-question-circle" style="font-size: 16px; margin-left: 10px; margin-right: 10px; color: #9370DB;"></i>Bantuan<i class="bi bi-arrow-right text-secondary" style="font-size: 16px; margin-left: 11.2rem;"></i></button>
            <!-- Modal -->
            <div class="modal fade" id="bantuan" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content" style="border: 1px solid #800080; border-radius: 20px; margin-top: 18rem;">
                        <div class="modal-body">
                            <div class="container">
                                <div class="row">
                                    <div class="col-12 text-center">
            ...
            <button class="btn-edit-akun" data-bs-toggle="modal" data-bs-target="#editsandi"><i class="bi bi-key" style="font-size: 16px; margin-left: 10px; margin-right: 10px; color: #9370DB;"></i>Edit Kata Sandi<i class="bi bi-arrow-right text-secondary" style="font-size: 16px; margin-left: 8.4rem;"></i></button>
            <!-- Modal -->
                        ...
                        <div class="modal-body">
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-12 text-center mt-2">
                                        <button id="simpanPasswordButton" class="btn" style="background-color: #9370DB; color: white; border: none;" disabled>Simpan</button>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <button class="btn-logout" data-bs-toggle="modal" data-bs-target="#logout"><i class="bi bi-box-arrow-right" style="font-size: 16px; margin-left: 10px; margin-right: 10px; color: red;"></i>Logout<i class="bi bi-arrow-right text-secondary" style="font-size: 16px; margin-left: 12rem;"></i></button>
            <!-- Modal -->
                        ...
                        <div class="modal-body">
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-12 d-flex gap-3" style="margin-left: 34px;">
