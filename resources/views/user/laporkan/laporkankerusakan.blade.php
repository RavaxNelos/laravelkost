...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('usercss/laporkankerusakan.css') }}">
    <!-- end css rava -->
            ...
            <div class="container mt-3">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-9 text-start">
                        <input type="text" class="input-kerusakan" placeholder="Barang yang mengalami kerusakan" disabled>
                    </div>
