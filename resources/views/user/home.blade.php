...
<body>
    <section x-data="{ filter: 'bulanan' }">
                ...
                <div class="row">
                    ...
                    <div class="col-5 text-end" style="margin-top: 7px;">
                        <div class="header-kanan">
                            <a href="/user/profil">
                                <img src="{{ asset($users->gambar ? 'uploadkamar/' . $users->gambar : '/img/customer1.jpg') }}"
                                    loading="lazy">
                            </a>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-12">
                    <div class="lokasi">
                        <p class="lokasi-atas"><i class="bi bi-geo-alt-fill text-danger"></i> Ruko City Pride B-23, Jl.
                            Nginden Semolo Waru 42 - Surabaya</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    @if ($banner->isEmpty())
                        <li class="splide__slide">
                            <div style="max-width: 300%; min-height: 200px; min-width: 250px;">
                                <div class="">
                                    <img src="{{ asset('img/reviewkost1.jpg') }}" style="border-radius: 0px;"
                                        class="w-100">
                                </div>
                            </div>
                        </li>
                        ...
                        @foreach ($banner as $item)
                            @if ($item->kategori_banner == 'Slider' && $item->lokasi_banner == 'Home Utama')
                                <li class="splide__slide">
                                    <div style="max-width: 300%; min-height: 200px; min-width: 250px;">
                                        <div class="">
                                            <img src="{{ asset('uploadkamar/' . $item->gambar_banner) }}"
                                                style="border-radius: 0px;" class="w-100">
                                        </div>
                                    </div>
                                </li>
                            @endif
        ...
        <div class="button-container">
            <button :class="filter == 'bulanan' ? 'btn btn-dark' : 'btn text-secondary'"
                x-on:click="filter = 'bulanan';" onclick="resetScroll('kategori-sewa')">Kost Bulanan</button>
            <button :class="filter == 'harian' ? 'btn btn-dark' : 'btn text-secondary'" x-on:click="filter = 'harian';"
                onclick="resetScroll('kategori-sewa')">Sewa Harian</button>
        </div>
                        ...
                        <div x-show="filter == '{{ strtolower($item->tipe_kost) }}'">
                            <a href="/user/detail/{{ $item->id }}">
                                <div class="position-relative mb-2">
                                    <img src="{{ asset('uploadkamar/' . $item->gambar_kost) }}"
                                        style="border-top-right-radius: 15px; border-top-left-radius: 15px; width: 226px; height: 236px; object-fit: cover;">
                                </div>
                                <div class="card-black"
                                    style="position: relative; margin-top: -8px; width: 226px; height: 100px; border-bottom-left-radius: 15px; border-bottom-right-radius: 15px; opacity: 0.9;">
                                    <h6 style="top: 10px; left: 10px; font-size: 18px; position: absolute; color: #333;"
                                        class="fw-semibold">{{ $item->kategori->kategori }}</h6>
                                    <i style="position: absolute; top: 32px; left: 10px; color: #333; font-size: 12px"
                                        class="bi bi-geo-alt text-info"></i><small
                                        style="position: absolute; top: 32px; left: 26px; font-size: 12px; color: #333"
                                        class="text-secondary;"> {{ $item->alamat_kost }}, Surabaya</small>
                                    <h6 style="position: absolute; top: 58px; left: 10px; font-size: 16px; color: #333;"
                                        class="fw-bold">Rp. {{ $item->harga_kost }}</h6>
                    ...
                    <ul class="splide__list">
                        @foreach ($banner as $item)
                            @if ($item->kategori_banner == 'Slider' && $item->lokasi_banner == 'Home Promo')
                                <li class="splide__slide">
                                    <img src="{{ asset('uploadkamar/' . $item->gambar_banner) }}" width="336"
                                        height="80" style="border-radius: 8px;">
                                </li>
                            @endif
                        @endforeach
                    </ul>
                    ...
                    <ul class="splide__list">
                        <li class="splide__slide">
                            <div class="custom-card"
                                style="position: relative; width: 130px; height: 80px; background-color: rgba(147, 112, 219, 0.6); border-radius: 8px;">
                                <div class="custom-card-body">
                                    <div class="lingkaran-logo"
                                        style="position: absolute; top: 10px; left: 8px; background-color: rgba(147, 112, 219, 1); width: 26px; height: 26px; border-radius: 30px; z-index: 999999;">
                                        <i class="bi bi-cash"
                                            style="color: white; padding: 6px; font-size: 14px;"></i></div>
                                    <p class="fw-semibold"
                                        style="font-size: 12px; position: absolute; top: 14px; left: 38px;">Sewa Kamar
                                    </p>
                                    <p class="fw-medium text-white"
                                        style="font-size: 12px; position: absolute; top: 40px; left: 8px;">Rp.25.000
                                    </p>
                                    <p class="text-body-tertiary"
                                        style="position: absolute; top: 58px; left: 8px; font-size: 10px; font-weight: 500;">
                                        Hemat Sewa Kamar</p>
                                </div>
                            </div>
                        </li>
                        <li class="splide__slide">
                            <div class="custom-card"
                                style="position: relative; width: 130px; height:80px; background-color: rgba(142, 68, 173, 0.6); border-radius: 8px;">
                                <div class="custom-card-body">
                                    <div class="lingkaran-logo"
                                        style="position: absolute; top: 10px; left: 8px; background-color: rgba(142, 68, 173, 1); width: 26px; height: 26px; border-radius: 30px; z-index: 999999;">
                                        <i class="bi bi-wallet"
                                            style="color: white; padding: 6px; font-size: 14px;"></i></div>
                                    <p class="fw-semibold"
                                        style="font-size: 12px; position: absolute; top: 14px; left: 38px;">Cashback
                                    </p>
                                    <p class="fw-medium text-white"
                                        style="font-size: 12px; position: absolute; top: 40px; left: 8px;">Rp.50.000
                                    </p>
                                    <p class="text-body-tertiary"
                                        style="position: absolute; top: 58px; left: 8px; font-size: 10px; font-weight: 500;">
                                        Potongan Harga Kost</p>
                                </div>
                            </div>
                        </li>
                        <li class="splide__slide">
                        ...
                        <li class="splide__slide">
                            <div class="custom-card"
                                ...
                                <div class="custom-card-body">
                                    ...
                                    <p class="fw-medium text-white"
                                        style="font-size: 12px; position: absolute; top: 40px; left: 8px;">Rp.100.000
                                    </p>
                                    <p class="text-body-tertiary"
                                        style="position: absolute; top: 58px; left: 8px; font-size: 10px; font-weight: 500;">
                                        Potongan Harga Kost</p>
                        ...
                        <li class="splide__slide">
                            <div class="custom-card"
                                ...
                                <div class="custom-card-body">
                                    ...
                                    <p class="fw-medium text-white"
                                        style="font-size: 12px; position: absolute; top: 40px; left: 8px;">Rp.75.000
                                    </p>
                                    <p class="text-body-tertiary"
                                        style="position: absolute; top: 58px; left: 8px; font-size: 10px; font-weight: 500;">
                                        Hemat Sewa Kamar</p>
        ...
        <div class="container">
            <div class="row mt-0" style="margin-bottom: 0.5rem;">
                <div class="col-7">
                    <h1 style="font-weight: bold; font-size: 18px; font-family: 'Inter', sans-serif;">Area Surabaya
                        Timur</h1>
                </div>
            </div>
            <div class="col-12 d-flex gap-2 justify-content-between"
                style="overflow-x: auto; overflow: overlay; margin-top: -10px; margin-bottom: 2rem;"
                id="katagori-sewa-timur">
                <!-- Area Surabaya Timur -->
                    ...
                    <div x-show="filter == '{{ strtolower($item->tipe_kost) }}'">
                        <a href="/user/detail/{{ $item->id }}" style="text-decoration: none;">
                            <div class="custom-card d-flex flex-column justify-content-between"
                                style="width: 180px; height: 290px; padding: 9px; border-radius: 15px; border: 1px solid #ccc;">
                                <div class="position-relative mb-2">
                                    <img src="{{ asset('uploadkamar/' . $item->gambar_kost) }}"
                                        style="border-radius: 15px; width: 160px; height: 160px; object-fit: cover;">
                                </div>
                                <div class="row m-0"> <!-- Tambahkan class m-0 untuk menghilangkan margin -->
                                    <div class="col-12 mt-1 p-0">
                                        <!-- Tambahkan class p-0 untuk menghilangkan padding -->
                                        <h6 style="font-size: 14px;" class="fw-medium mb-1 text-secondary-emphasis">
                                            Kamar Uk. {{ $item->ukuran_kost }}</h6>
                                    </div>
                                    <div class="col-12 p-0"> <!-- Tambahkan class p-0 untuk menghilangkan padding -->
                                        <h6 style="font-size: 10px;" class="text-secondary">Fasilitas:
                                            {{ Illuminate\Support\Str::limit($item->fasilitas_kost, 24, '...') }}</h6>
                                    </div>
                                    <div class="col-12 text-center p-0">
                                        <!-- Tambahkan class p-0 untuk menghilangkan padding -->
                                        <h3 style="font-size: 17px;" class="text-dark mb-0 fw-bold">Rp.
                                            {{ $item->harga_kost }}</h3>
                                    </div>
                                    <div class="col-12 mt-2 text-center p-0">
                                        <!-- Tambahkan class p-0 untuk menghilangkan padding -->
                                        <form action="/user/detail/{{ $item->id }}">
                                            <button class="btn-area-timur-surabaya justify-content-center">Pesan
                                                Sekarang</button>
                                        </form>
                                    </div>
                                </div>
                    ...
                    <ul class="splide__list">
                        @foreach ($banner as $item)
                            @if ($item->kategori_banner == 'Slider' && $item->lokasi_banner == 'Home Ketiga')
                                <li class="splide__slide">
                                    <img src="{{ asset('uploadkamar/' . $item->gambar_banner) }}"
                                        style="border-radius: 15px; width: 334px; height: 150px; object-fit: cover;">
                                </li>
                            @endif
                        @endforeach
                    </ul>
        ...
        <div class="container">
            <div class="row mt-3" style="margin-bottom: 0.5rem;">
                <div class="col-7">
                    <h1 style="font-weight: bold; font-size: 18px; font-family: 'Inter', sans-serif;">Kamar Kost Putra
                    </h1>
                </div>
            </div>
            <div class="col-12 d-flex gap-2"
                style="overflow-x: auto; overflow: overlay; margin-top: -10px; margin-bottom: 2rem;"
                id="kategori-sewa-putra">
                    ...
                    <div x-show="filter == '{{ strtolower($item->tipe_kost) }}'">
                        <a href="/user/detail/{{ $item->id }}" style="text-decoration: none;">
                            <div class="card" style="padding: 10px; border-radius: 15px;">
                                <div class="position-relative mb-2">
                                    <img src="{{ asset('uploadkamar/' . $item->gambar_kost) }}"
                                        style="border-radius: 15px; width: 220px; height: 150px; object-fit: cover;">
                                    {{-- <button id="btn-like-timur" class="btn-like-putra" onclick="changeIconAndColor(this)"><i class="bi bi-star"></i></button> --}}
                                </div>
                                <div class="row">
                                    <div class="col-7 mt-2">
                                        <h3 style="font-size: 15px; margin-left: -12px;"
                                            class="text-dark mb-0 fw-bold text-center">Rp. {{ $item->harga_kost }}
                                        </h3>
                                    </div>
                                    <div class="col-5">
                                        <form action="/user/detail/{{ $item->id }}">
            ...
            @if ($kamarkost_populer)
                <div class="row" style="margin-bottom: 0.5rem; margin-top: -0.5rem">
                    <div class="col-8">
                        <h1 style="font-weight: bold; font-size: 18px; font-family: 'Inter', sans-serif;">Kamar Kost
                            Populer</h1>
                    </div>
                </div>
                <div class="col-12 d-flex gap-2"
                    style="overflow-x: auto; overflow: overlay; margin-top: -10px; margin-bottom: 2rem;"
                    id="kategori-sewa-populer">
                    <!-- Kamar Populer -->
                    @foreach ($kamarkost_populer as $item)
                        <div x-show="filter == '{{ strtolower($item->tipe_kost) }}'">
                            <a href="/user/detail/{{ $item->id }}" style="text-decoration: none;">
                                <div class="custom-card"
                                    style="width: 260px; height: 116px; padding: 9px; border-radius: 15px; border: 1px solid #ccc;">
                                    <div class="position-relative mb-2">
                                        <div class="row">
                                            <div class="col-4 mb-0">
                                                <img src="{{ asset('uploadkamar/' . $item->gambar_kost) }}"
                                                    style="border-radius: 15px; width: 90px; height: 90px; object-fit: cover;">
                                            </div>
                                            <div class="col-4" style="width: 150px; margin-left: 16px;">
                                                <h6 style="font-size: 16px; margin-top: 10px;"
                                                    class="fw-bold text-secondary-emphasis">
                                                    {{ $item->kategori->kategori }}</h6>
                                                <p style="margin-top: -5px; font-size: 12px; color: #6a6666fa;"
                                                    class="mb-2 fw-normal">Uk. Kamar {{ $item->ukuran_kost }}</p>
                                                <form action="/user/detail/{{ $item->id }}">
                                                    <button class="btn-kost-populer"
                                                        style="width: 125px; height: 33px; padding: 4px;">
                                                        <p>Cek</p>
                                                    </button>
                                                </form>
                                            </div>
        ...
        <div class="container">
            <div class="row mt-3" style="margin-bottom: 0.5rem;">
                <div class="col-7">
                    <h1 style="font-weight: bold; font-size: 18px; font-family: 'Inter', sans-serif;">Kamar Kost Putri
                    </h1>
                </div>
            </div>
            <div class="col-12 d-flex gap-2"
                style="overflow-x: auto; overflow: overlay; margin-top: -10px; margin-bottom: 2rem;"
                id="kategori-sewa-putri">
                <!-- Kamar Kost Putri -->
                        ...
                        <ul class="splide__list">
                            @foreach ($banner as $item)
                                @if ($item->kategori_banner == 'Slider' && $item->lokasi_banner == 'Home Terakhir')
                                    <li class="splide__slide">
                                        <img src="{{ asset('uploadkamar/' . $item->gambar_banner) }}"
                                            style="border-radius: 15px; width: 334px; height: 160px; object-fit: cover;">
                                    </li>
                                @endif
                            @endforeach
                        </ul>
        ...
        <div class="container">
            ...
            <div class="col-12 d-flex gap-2 justify-content-between"
                style="overflow-x: auto; overflow: overlay; margin-top: -10px; margin-bottom: 2rem;"
                id="kategori-sewa-barat">
                <!-- Area barat surabaya -->
                @foreach ($kamarkost_area_surabaya_barat as $item)
                    <div x-show="filter == '{{ strtolower($item->tipe_kost) }}'">
                        <a href="/user/detail/{{ $item->id }}" style="text-decoration: none;">
                            <div class="custom-card"
                                style="width: 266px; height: 180px; padding: 0px; border-radius: 15px; border: 1px solid #ccc;">
                                <div class="position-relative mb-2">
                                    <img src="{{ asset('uploadkamar/' . $item->gambar_kost) }}"
                                        style="border-top-left-radius: 13px; border-top-right-radius: 13px; width: 264px; height: 80px; object-fit: cover;">
                                </div>
                                <div style="width: 266px; padding-left: 14px; padding-right: 14px;">
                                    <!-- Sesuaikan padding -->
                                    <div class="col-12 mt-1">
                                        <h6 style="font-size: 16px;" class="fw-bold text-secondary-emphasis mb-1">
                                            Kamar Kost Uk. {{ $item->ukuran_kost }}</h6>
                                    </div>
                                    <div class="col-12">
                                        <h6 style="font-size: 12px;" class="text-secondary">Fasilitas:
                                            {{ Illuminate\Support\Str::limit($item->fasilitas_kost, 32, '...') }}</h6>
                                    </div>
                                    <div class="col-12">
                                        <form action="/user/detail/{{ $item->id }}">
            ...
            <div class="row" style="margin-bottom: 2.8rem; margin-top: -0.5rem">
                <div class="col-12">
                    <h1 style="font-weight: bold; font-size: 18px; font-family: 'Inter', sans-serif;">Rekomendasi Kamar
                        Kost</h1>
                    <div class="col-12 d-flex gap-2"
                        style="overflow-x: auto; overflow: overlay; margin-bottom: 4.8rem;"
                        id="kategori-sewa-rekomendasi">
                            ...
                            <div x-show="filter == '{{ strtolower($item->tipe_kost) }}'">
                                <a href="/user/detail/{{ $item->id }}" style="text-decoration: none;">
                                    <div class="card" style="padding: 10px; border-radius: 15px;">
                                        <div class="position-relative mb-2">
                                            <img src="{{ asset('uploadkamar/' . $item->gambar_kost) }}"
                                                style="border-radius: 15px; width: 220px; height: 140px; object-fit: cover;">
                                        </div>
                                        <div class="row g-3">
                                            <div class="col-10">
                                                <h6 style="font-size: 16px; margin-bottom: -0.3rem;" class="fw-bold">
                                                    {{ $item->kategori->kategori }}</h6>
                                            </div>
                                        </div>
                                        <div class="row g-3 mb-3">
                                            <div class="col-12">
                                                <small style="font-size: 12px; margin-top: -40px;"
                                                    class="mb-0 text-secondary fw-normal"><i
                                                        class="bi bi-geo-alt-fill text-danger"></i>
                                                    {{ $item->alamat_kost }}, Surabaya</small>
                                            </div>
                                        </div>
                                        <div class="row" style="margin-top: -10px;">
                                            <div class="col-8">
                                                <h3 style="margin-top: 5px; font-size: 18px; color: #9370DB;"
                                                    class="mb-0 fw-bold">Rp. {{ $item->harga_kost }}</h3>
                                            </div>
                                            <div class="col-4">
                                                <form action="/user/detail/{{ $item->id }}">
                                                    <button class="btn-rekomendasi-rumah"
                                                        style="margin-left: -20px;">Lihat</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
