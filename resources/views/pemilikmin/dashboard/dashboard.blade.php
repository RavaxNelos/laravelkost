    ...
    <div class="owl-carousel counter-carousel owl-theme">
            ...
            <div class="card border-0 zoom-in bg-light-warning shadow-none">
                <div class="card-body">
                    <div class="text-center">
                        <img src="{{ asset('admin') }}/dist/images/svgs/icon-account.svg" width="50" height="50" class="mb-3" alt="" />
                        <p class="fw-semibold fs-3 text-warning mb-1">Pengguna</p>
                        <h5 class="fw-semibold text-warning mb-0">{{ $jumlahPengguna }}</h5>
                    </div>
                </div>
            </div>
        </div>        
            ...
            <div class="card border-0 zoom-in bg-light-danger shadow-none">
                <div class="card-body">
                    <div class="text-center">
                        ...
                        <p class="fw-semibold fs-3 text-danger mb-1">Penghuni</p>
                        <h5 class="fw-semibold text-danger mb-0">{{ $jumlahPenghuni }}</h5>
                    </div>
                </div>
            </div>
        </div>        
        ...
        <div class="item">
            <div class="card border-0 zoom-in bg-light-primary shadow-none">
                <div class="card-body">
                    <div class="text-center">
                        <img src="{{ asset('admin') }}/dist/images/svgs/icon-cart.svg" width="50" height="50" class="mb-3" alt="" />
                        <p class="fw-semibold fs-3 text-primary mb-1">Pembayaran</p>
                        <h5 class="fw-semibold text-primary mb-0">{{ $jumlahPembayaran }}</h5>
                    </div>
                </div>
            </div>
        </div>
        <div class="item">
            <div class="card border-0 zoom-in bg-light-success shadow-none">
                <div class="card-body">
                    <div class="text-center">
                        <img src="{{ asset('admin') }}/dist/images/svgs/icon-mail.svg" width="50" height="50" class="mb-3" alt="" />
                        <p class="fw-semibold fs-3 text-success mb-1">Lapor</p>
                        <h5 class="fw-semibold text-success mb-0">{{ $jumlahlaporan }}</h5>
                    </div>
                </div>
            </div>
        </div>
