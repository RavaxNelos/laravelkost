...
@section('content')
    ...
    @if (count($fasilitas) > 0)
                ...
                <div class="row">
                    <div class="col-md-4 col-xl-3">
                        <form class="position-relative">
                            <input type="text" class="form-control product-search ps-5" id="input-search" placeholder="Cari Fasilitas..." />
                    ...
                    <div class="col-md-8 col-xl-9 text-end d-flex justify-content-md-end justify-content-center mt-3 mt-md-0">
                        <a data-bs-toggle="modal" data-bs-target="#modaltambah" id="btn-add-contact" class="btn btn-info d-flex align-items-center">
                            <i class="ti ti-plus text-white me-1 fs-5"></i> Tambah Fasilitas
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="modal fade" id="modaltambah" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document" x-data="{ gambar: '', nama: '', tipe: '', deskripsi: '' }">
                <div class="modal-content" style="width: 100%; height: 540px;">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5 fw-semibold" id="exampleModalLabel">Tambah Fasilitas</h1>
                    </div>
                                ...
                                <form action="{{ route('fasilitas.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-12 text-start">
                                            <label for="Gambar Fasilitas">Gambar Fasilitas <span class="text-danger">*</span></label>
                                        </div>
                                        ...
                                        <div class="col-12 text-start">
                                            <label for="Nama Fasilitas">Nama Fasilitas <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-md-12 mb-4" style="margin-top: -6px;">
                                            <div class="mt-3">
                                        ...
                                        <div class="col-12 text-start">
                                            <label for="Tipe Fasilitas">Tipe Fasilitas <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-md-12 mb-4" style="margin-top: -6px;">
                                            <div class="mt-3">
                                        ...
                                        <div class="col-12 text-start">
                                            <label for="Deskripsi Fasiitas">Deskripsi Fasiitas <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-md-12 mb-4" style="margin-top: -6px;">
                                            <div class="mt-3">
                                                <div class="form-group">
                                                    <textarea class="form-control" name="deskripsi" id="deskripsi" value="{{ old('deskripsi') }}" rows="2" placeholder="Ketik Deskripsi Fasilitas..." maxlength="300" x-model="deskripsi"></textarea>
                                                    @error('deskripsi')
                                                        {{ $message }}
                                                    @enderror
                                                </div>
                                        ...
                                        <div class="col-12 text-end">
                                            <div class="align-items-center mt-3">
                                                <div class="ms-auto mt-3 mt-md-0">
                                                    ...
                                                    <button type="submit" class="btn btn-info font-medium" :class="gambar && nama && tipe && deskripsi ? null : 'disabled'">
        ...
        <div class="card card-body">
            <div class="table-responsive">
                <table class="table search-table align-middle text-nowrap">
                    <thead class="header-item">
                        ...
                        <th class="text-center">Tipe Fasilitas</th>
                        <th class="text-center">Deskripsi Fasilitas</th>
                            ...
                            <tr class="search-items">
                                <td class="text-center">
                                    <div class="d-flex align-items-center">
                                        <img src="{{ asset('uploadkamar/' . $item->gambar) }}" class="rounded-1" style="width: 200px; height: 100px;" />
                                    </div>
                                </td>
                                <td class="text-center">
                                    <span class="usr-nama-banner">{{ $item->nama }}</span>
                                </td>
                                <td class="text-center">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content" style="width: 100%; height: 540px;">
                                                    ...
                                                    <div class="modal-body" style="margin-top: -20px;">
                                                        <div class="container">
                                                            <div class="row">
                                                                <form action="/pemilikmin/editfasilitas" method="POST" enctype="multipart/form-data">
                                                                    @csrf
                                                                    <input type="hidden" name="id" value="{{ $item->id }}">
                                                                    <div class="row">
                                                                        <div class="col-12 text-start">
                                                                            <label for="Gambar Fasilitas">Gambar Fasilitas</label>
                                                                        </div>
                                                                        <div class="col-12 text-center">
                                                                            <div class="col-md-12 mt-1">
                                                                                <img src="{{ asset('uploadkamar/' . $item->gambar) }}" class="rounded-1" style="width: 100%; height: 150px;">
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-12 text-start mt-1">
                                                                            <label for="Tipe Fasilitas">Tipe Fasilitas</label>
                                                                        </div>
                                                                        <div class="col-md-12" style="margin-top: -14px;">
                                                                            <div class="mt-3">
                                                                                <div class="input-group">
                                                                                    <select class="form-select" id="tipe" name="tipe">
                                                                                        <option value="Kamar" {{ $item->tipe == 'Kamar' ? 'selected' : '' }}>Kamar</option>
                                                                                        <option value="Kamar Mandi" {{ $item->tipe == 'Kamar Mandi' ? 'selected' : '' }}>Kamar Mandi</option>
                                                                                        <option value="Umum" {{ $item->tipe == 'Umum' ? 'selected' : '' }}>Umum</option>
                                                                        ...
                                                                        <div class="col-12 text-start mt-1">
                                                                            <label for="Deskripsi Fasilitas">Deskripsi Fasilitas</label>
                                                                        </div>
                                                                        <div class="col-md-12" style="margin-top: -14px;">
                                                                            <div class="mt-3">
                                                                                <div class="input-group">
                                                                                    <input type="text" class="form-control" maxlength="300" name="deskripsi" id="deskripsi" value="{{ $item->deskripsi }}">
                                                                                    @error('deskripsi')
                                                                                        {{ $message }}
                                                                                    @enderror
                                                                                </div>
            ...
            @else
                ...
                <div class="col-12 text-center mt-2">
                    <h1 class="fw-medium fs-3">Belum Ada Data Fasilitas</h1>
                </div>
...
@push('scripts')
    ...
    <script>
        ...
        function confirmDelete(itemId) {
            ...
            deleteForm.action = '/pemilikmin/fasilitas/destroy/' + itemId;
