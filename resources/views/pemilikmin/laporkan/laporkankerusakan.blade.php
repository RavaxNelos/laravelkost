                            ...
                            <tr class="search-items">
                                ...
                                <td class="text-center">
                                    <div class="d-flex justify-content-center">
                                            ...
                                            <div class="modal-dialog modal-dialog-scrollable">
                                                <div class="modal-content"style="width: 100%; height: 540px;">
                                                    <div class="modal-header">
                                                        <h1 class="modal-title fs-5 fw-semibold" id="exampleModalLabel">Detail Laporkan Kerusakan</h1>
                                                    </div>
                                                        ...
                                                        <div class="container">
                                                            <div class="row" style="margin-top: -20px;">
                                                                ...
                                                                <div class="col-6 text-start mt-3">
                                                                    <label for="Tanggal Lapor Kerusakan">Tanggal Lapor Kerusakan</label>
                                                                </div>
                                                                <div class="col-6 text-start mt-3">
                                                                    <label for="Barang Yang Rusak">Barang Yang Rusak</label>
                                                                </div>
                                                                <div class="col-md-6" style="margin-top: -12px;">
                                                                    <div class="mt-3">
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control" name="tanggal_lapor" value="{{ Carbon\Carbon::parse($item->tanggal_lapor)->locale('id')->isoFormat('DD MMMM Y') }}" id="tanggal_lapor" disabled>
                                                                            @error('tanggal_lapor')
                                                                                {{ $message }}
                                                                            @enderror
                                                                        </div>
                                                                ...
                                                                <div class="col-md-6" style="margin-top: -12px;">
                                                                    <div class="mt-3">
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control" name="barang_rusak" value="{{ $item->barang_rusak }}" id="barang_rusak" disabled>
                                                                            @error('barang_rusak')
                                                                                {{ $message }}
                                                                            @enderror
                                                                        </div>
                                                                ...
                                                                <div class="col-12 text-start mt-3 mb-3">
                                                                    <label for="Gambar Kerusakan">Gambar Kerusakan</label>
                                                                </div>
                                                                <div class="col-3">
                                                                    @isset($item->gambarkerusakan->input1)
                                                                        <img src="{{ asset('uploadkamar/' . $item->gambarkerusakan->input1) }}" style="border-radius: 6px; width: 90px; height: 90px;" data-bs-target="#detailgambar1-{{ $item->gambarkerusakan->id }}" data-bs-toggle="modal">
                                                                    @endisset
                                                                </div>
                                                                <div class="col-3">
                                                                    @isset($item->gambarkerusakan->input2)
                                                                        <img src="{{ asset('uploadkamar/' . $item->gambarkerusakan->input2) }}" style="border-radius: 6px; width: 90px; height: 90px;" data-bs-target="#detailgambar2-{{ $item->gambarkerusakan->id }}" data-bs-toggle="modal">
                                                                    @endisset
                                                                </div>
                                                                <div class="col-3">
                                                                    @isset($item->gambarkerusakan->input3)
                                                                        <img src="{{ asset('uploadkamar/' . $item->gambarkerusakan->input3) }}" style="border-radius: 6px; width: 90px; height: 90px;" data-bs-target="#detailgambar3-{{ $item->gambarkerusakan->id }}" data-bs-toggle="modal">
                                                                    @endisset
                                                                </div>
                                                                <div class="col-3">
                                                                    @isset($item->gambarkerusakan->input4)
                                                                        <img src="{{ asset('uploadkamar/' . $item->gambarkerusakan->input4) }}" style="border-radius: 6px; width: 90px; height: 90px;" data-bs-target="#detailgambar4-{{ $item->gambarkerusakan->id }}" data-bs-toggle="modal">
                                                                    @endisset
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="modal fade" id="detailgambar1-{{ $item->gambarkerusakan->id }}" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <input type="hidden" name="id" value="{{ $item->gambarkerusakan->id }}">
                                                        <div class="container">
                                                            <img src="{{ asset('uploadkamar/' . $item->gambarkerusakan->input1) }}" style="border-radius: 6px; width: 100%; height: 400px;">
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#lihat-{{ $item->id }}">Kembali</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="modal fade" id="detailgambar2-{{ $item->gambarkerusakan->id }}" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h1 class="modal-title fs-5" id="exampleModalToggleLabel2">Gambar Kerusakan</h1>
                                                    ...
                                                    <div class="modal-body">
                                                        <input type="hidden" name="id" value="{{ $item->gambarkerusakan->id }}">
                                                        <div class="container">
                                                            <img src="{{ asset('uploadkamar/' . $item->gambarkerusakan->input2) }}" style="border-radius: 6px; width: 100%; height: 400px;">
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#lihat-{{ $item->id }}">Kembali</button>
                                        ...
                                        <div class="modal fade" id="detailgambar3-{{ $item->gambarkerusakan->id }}" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h1 class="modal-title fs-5" id="exampleModalToggleLabel2">Gambar Kerusakan</h1>
                                                    ...
                                                    <div class="modal-body">
                                                        <input type="hidden" name="id" value="{{ $item->gambarkerusakan->id }}">
                                                        <div class="container">
                                                            <img src="{{ asset('uploadkamar/' . $item->gambarkerusakan->input3) }}" style="border-radius: 6px; width: 100%; height: 400px;">
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#lihat-{{ $item->id }}">Kembali</button>
                                        ...
                                        <div class="modal fade" id="detailgambar4-{{ $item->gambarkerusakan->id }}" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h1 class="modal-title fs-5" id="exampleModalToggleLabel2">Gambar Kerusakan</h1>
                                                    ...
                                                    <div class="modal-body">
                                                        <input type="hidden" name="id" value="{{ $item->gambarkerusakan->id }}">
                                                        <div class="container">
                                                            <img src="{{ asset('uploadkamar/' . $item->gambarkerusakan->input4) }}" style="border-radius: 6px; width: 100%; height: 400px;">
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#lihat-{{ $item->id }}">Kembali</button>
                                        ...
                                        <div class="modal fade" id="respon-{{ $item->id }}" data-bs-backdrop="static" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content"style="width: 100%; height: 350px;">
                                                    <div class="modal-header">
                                                        <h1 class="modal-title fs-5 fw-semibold" id="exampleModalLabel">Respon Laporan Kerusakan</h1>
                                                    </div>
                                                    <div class="modal-body">
                                                        <div class="container">
                                                            <form action="{{ route('responkerusakan.store') }}" method="POST" enctype="multipart/form-data" x-data="{ respon: '' }">
                                                                @csrf
                                                                <div class="row" style="margin-top: -10px;">
                                                                    ...
                                                                    <div class="col-12 text-start mt-3">
                                                                        <label for="Respon Untuk Laporan Kehilangan">Respon Untuk Laporan Kerusakan</label>
                                                                    </div>
